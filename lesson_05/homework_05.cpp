...
int main()
{
	...
	print_array(my_iarray_2, SIZE);			// выводим массив, заполненный в соответсвии с заданием
	std::cout << std::endl;
	fill_array(my_iarray_2, SIZE, 5, 10);	// звполняем с использованием всех параметров
	print_array(my_iarray_2, SIZE);			// выводим массив, заполненный с использованием всех параметров
	std::cout << std::endl;
	...
	print_array(my_iarray_2, SIZE);			// выводим исходный массив {1, 2, 3, 4, 5, 6, 7, 8}
	std::cout << std::endl;
	cyclic_shift(my_iarray_2, SIZE, -2);
	print_array(my_iarray_2, SIZE);			// выводим массив после сдвига на 2 влево {3, 4, 5, 6, 7, 8, 1, 2}
	std::cout << std::endl;
	cyclic_shift(my_iarray_2, SIZE, 3);
	print_array(my_iarray_2, SIZE);			// выводим массив после сдвига на 3 вправо {8, 1, 2, 3, 4, 5, 6, 7}
	std::cout << std::endl;
